...
<main class="index__main">
        ...
        <?php endwhile; else: ?>
            ...
            <div class="background__pic">
                <img src="<?= get_template_directory_uri(); ?>/src/images/index-background.png" alt="Goran Schyns">
            </div>
            ...
            <div class="social__media">
                ...
                <ul class="media__ul">
                    ...
                    if ($home->have_posts()): while ($home->have_posts()) : $home->the_post();
                    ?>
                    <li class="media__li vertical__line">
                        <div></div>
                    </li>
                    <li class="media__li">
                        <a class="media__link github" href="<?php the_field('github'); ?>" title="Github">
                    ...
                    <li class="media__li">
                        <a class="media__link facebook" href="<?php the_field('facebook'); ?>" title="Facebook">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <li class="media__li">
                        <a class="media__link instagram" href="<?php the_field('instagram'); ?>" title="Instagram">
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
